    ...
    switch ($act) {
        ...
        case 'capnhattaikhoan':
            if (isset($_POST['capnhat']) && ($_POST['capnhat'])) {
                ...
                update_user($id_user, $ten_user, $Mat_khau, $email, $img);
                // header("location:index2.php?act=capnhattaikhoan");
            }
        ...
        case 'quenmk':
            if (isset($_POST['gui']) && ($_POST['gui'])) {
                $user = $_POST['user'];
                $checkuser1 = checkuser1($user);
                if (is_array($checkuser1)) {
                    $thongbao = "Mat_khau của bạn là " . $checkuser1['Mat_khau'];
                } else {
