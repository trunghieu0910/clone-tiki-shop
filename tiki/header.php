...
<!-- khu vực bọ sưu tập nôi bật -->
 ...
 <!-- khu vực giá sale -->       
        <div class="col-phai-2 rounded-md my-1">
          <h1 style=" font-weight: 700;margin-left: 1.2%; width: 90%; margin-top: 1%; " >Giá Tốt Hôm Nay   <p id="countdown" style=" position: absolute;margin-left: 10%; margin-top: -1.22%;"></p></h1>
    ...
    <div class="col-phai-1 rounded-md my-1   ">
      ...
      <div class="sp filtering my-2 ">
        ...
        <div class="sp1"><img src="tiki/img/hh2.png" alt=""> <img src="tiki/img/hh3.png" alt=""style="margin-top: 1%;"></div>
        <div class="sp1 "><img src="tiki/img/hh4.png" alt=""></div>
        <div class="sp1 "><img src="tiki/img/hh5.png" alt=""><img src="tiki/img/hh6.png" alt="" style="margin-top: 1%;"></div>
        <div class="sp1 "><img src="tiki/img/hh8.png" alt=""> <img src="tiki/img/hh5.png" alt="" style="margin-top: 1%;"></div>
        <div class="sp1 "><img src="tiki/img/hh4.png" alt=""></div>
  </div>
  </div>
<!-- khu vực danh mục nổi bật  -->
<div class="col-phai-2 rounded-md my-1 hu">
          <h1 style=" font-weight: 700;margin-left: 1.2%; width: 90%; margin-top: 1%; " >Danh Mục Nổi bật<p id="countdown" style=" position: absolute;margin-left: 10%; margin-top: -1.22%;"></p></h1>
         <div class="sp filtering my-2 ">
         <?php
                     foreach($htdm as $dm){
                    extract($dm);
...
?>
  ...
  <div class="col-phai-1 rounded-md my-1 h">
     ...
     <!-- chuyển tap -->
  <div class="tabs">
    <img src="tiki/img/011.webp" alt="" style="position: absolute;width: 2.8%; margin-left: 5.0%; margin-top: 0.5%;"><button class="tablinks active" data-electronic="allproducts">Dành cho bạn</button>
    <img src="tiki/img/022.webp" alt="" style="position: absolute;width: 2.8%; margin-left: 17.5%;margin-top: 0.5%;"><button class="tablinks" data-electronic="Microcontrollers">Rẻ Mỗi Ngày </button>
    <img src="tiki/img/033.webp" alt="" style="position: absolute;width: 2.8%; margin-left: 30.5%;margin-top: 0.5%;"><button class="tablinks" data-electronic="module">Freeship</button>
    <img src="tiki/img/044.webp" alt="" style="position: absolute;width: 2.8%; margin-left: 43.2%;margin-top: 0.5%;"><button class="tablinks" data-electronic="modulee">Astra plus</button>
    <img src="tiki/img/055.webp" alt="" style="position: absolute;width: 2.8%; margin-left: 55.5%;margin-top: 0.5%;"><button class="tablinks" data-electronic="modulee3">dịch vụ số</button>
    <img src="tiki/img/066.webp" alt="" style="position: absolute;width: 2.8%; margin-left: 68.2%;margin-top: 0.5%;"><button class="tablinks" data-electronic="modulee1">Deal Siêu hot</button>
 </div>
